...
CREATE TABLE "dyn_sql" ("id" SERIAL NOT NULL, "sql" text NOT NULL, "createDate" TIMESTAMP NOT NULL DEFAULT now(), "updateDate" TIMESTAMP NOT NULL DEFAULT now(), "dynDbId" integer, CONSTRAINT "PK_3893ccb87f7af00775e8d00b86a" PRIMARY KEY ("id"));
...
ALTER TABLE "dyn_sql" ADD "sqlAlias" character varying;
ALTER TABLE "dyn_sql" ADD CONSTRAINT "UQ_2f17cefbea486efe5b3482334bd" UNIQUE ("sqlAlias");
