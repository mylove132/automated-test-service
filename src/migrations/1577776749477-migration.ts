...
export class migration1577776749477 implements MigrationInterface {
    name = 'migration1577776749477'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "userId" integer`, undefined);
