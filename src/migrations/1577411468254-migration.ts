...
export class migration1577411468254 implements MigrationInterface {
    name = 'migration1577411468254'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "secheduler" ("id" SERIAL NOT NULL, "md5" character varying NOT NULL, "createDate" TIMESTAMP NOT NULL DEFAULT now(), "updateDate" TIMESTAMP NOT NULL DEFAULT now(), "caseListId" integer, "envId" integer, CONSTRAINT "UQ_7df896c01ff7c4192a3dfb83f70" UNIQUE ("md5"), CONSTRAINT "REL_ed8cc133f74b5c7a7217cb7934" UNIQUE ("caseListId"), CONSTRAINT "REL_1e74448f8a690f0f38a2d84be0" UNIQUE ("envId"), CONSTRAINT "PK_3405795f816a3563ba9600f5f89" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "catalog" ADD CONSTRAINT "FK_6b0daca4bde404abcf88f305f03" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "history" ADD CONSTRAINT "FK_66f6eb43821666df150f4dcf2e1" FOREIGN KEY ("caseId") REFERENCES "case"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "caselist" ADD CONSTRAINT "FK_d16db6fb900fded908867619508" FOREIGN KEY ("envId") REFERENCES "env"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "case" ADD CONSTRAINT "FK_6f14c4f8d3ac48202e729524cd4" FOREIGN KEY ("endpointObjectId") REFERENCES "endpoint"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
