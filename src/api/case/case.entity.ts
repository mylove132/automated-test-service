...
export class CaseEntity {
    ...
    @ManyToOne(type => CatalogEntity, catalog => catalog.cases, {cascade: true, onDelete: 'SET NULL', onUpdate: 'CASCADE'})
    ...
    @ManyToOne(type => AssertTypeEntity, assert => assert.cases, {cascade: true,onDelete: 'SET NULL',onUpdate: 'CASCADE'})
    ...
    @ManyToOne(type => EndpointEntity, endpoint => endpoint.cases,{cascade: true,onDelete: 'SET NULL',onUpdate: 'CASCADE'})
